...
angular.module('ua5App')
    .directive('pano', ['$rootScope', 'BaseThreeScene', 'BrowserFactory', 'GeoFactory', 'Hotspot', 'SpaceFactory', function($rootScope, BaseThreeScene, BrowserFactory, GeoFactory, Hotspot, SpaceFactory) {
        return {
            restrict: 'A',
